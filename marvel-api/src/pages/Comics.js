...
export default function Comics(props) {
  ...
  const [renderComics, setRenderComics] = useState(5);
  ...
  `http://gateway.marvel.com/v1/public/comics?ts=1&apikey=b4dd4282e1b25f7c72aa3cba77ab4ce4&hash=4232dd5bcab38413ba6d13fd93d1ec65&orderBy=title&limit=${renderComics}`
  );
      ...
      <Grid>
        <Grid.Column>
          ...
          <Card.Group itemsPerRow={5}>
            ...
            <ListComic  renderComics={renderComics} setRenderComics={setRenderComics} listComics={listComics}/>
          </Card.Group>
